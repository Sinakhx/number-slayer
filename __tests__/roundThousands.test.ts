...
describe('roundThousands', () => {
    it('should round a big number to a certain power of 10', () => {
    ...
    it('should round a big number to a certain power of 10 with 3 digits percision', () => {
    ...
    it('should round a big number to a certain power of 10 with "floor" format', () => {
    ...
    it('should round a big number to a certain power of 10 with "ceil" format', () => {
    ...
    it('should round a big number to a certain power of 10 with "round" format', () => {
